...
type Querier interface {
	...
	ListAppMembers(ctx context.Context, arg ListAppMembersParams) ([]Member, error)
	...
	ListFamilyMembers(ctx context.Context, arg ListFamilyMembersParams) ([]Member, error)
